...
const uint8     USER_ID_LEN             = 64;
const uint8     NR_WAVELEN_POL_COEF     = 5;
const uint8     NR_NONLIN_POL_COEF      = 8;
const uint8     NR_DEFECTIVE_PIXELS     = 30;
const uint16    MAX_NR_PIXELS           = 4096;
const uint8     NR_TEMP_POL_COEF        = 5;
const uint8     MAX_TEMP_SENSORS        = 3;
const uint8     ROOT_NAME_LEN           = 6;
const uint8     AVS_SERIAL_LEN          = 10;
const uint8     MAX_VIDEO_CHANNELS      = 2;
const uint16    MAX_LASER_WIDTH         = 0xFFFF;
const uint8     HW_TRIGGER_MODE         = 1;
const uint8     SW_TRIGGER_MODE         = 0;
const uint8     EXTERNAL_TRIGGER        = 0;
const uint8     SYNC_TRIGGER            = 1;
const uint8     EDGE_TRIGGER_SOURCE     = 0;
const uint8     LEVEL_TRIGGER_SOURCE    = 1;
const uint8     MAX_TRIGGER_MODE        = 1;
const uint8     MAX_TRIGGER_SOURCE      = 1;
const uint8     MAX_TRIGGER_SOURCE_TYPE = 1;
const uint32    MAX_INTEGRATION_TIME    = 600000;    // 600 seconds

const uint8     SAT_DISABLE_DET         = 0;
const uint8     SAT_ENABLE_DET          = 1;
const uint8     SAT_PEAK_INVERSION      = 2; 
const uint8     NR_DAC_POL_COEF         = 2;

const uint8     NTC1_ID                 = 0;
const uint8     NTC2_ID                 = 1;
const uint8     TEC_ID                  = 2; 
